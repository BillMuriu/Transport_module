...
import { useCreateDriver } from "@/app/school_admin/drivers/services/mutations";
    ...
    createDriver(payload, {
      onSuccess: async () => {
        ...
        try {
          ...
          if (data) setSelectedSchool(data); // ✅ Update store with fresh data
        } catch (err) {
          console.error("Failed to refresh school data:", err);
        }
        setOpenBackdrop(false);
        router.push("/super_admin/drivers");
      },
      onError: () => {
